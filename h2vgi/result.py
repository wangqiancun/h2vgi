...
def save_location_state(location, timestep, date_from, date_to,
                        ...
                        power_demand=None, hydrogen=None, nb_interval=None,
    ...
    Args:
        ...
        hydrogen (list): state of charge from the parked activity
    ...
    if run:
        ...
        if save:
            ...
            #           for soc in hydrogen[activity_index1:activity_index2]])
...
def save_vehicle_state(vehicle, timestep, date_from,
                       date_to, activity=None, power_demand=None, hydrogen=None,
    ...
    """
    if init:
        vehicle.hydrogen = [vehicle.hydrogen[0]]
        vehicle.result = None


def save_vehicle_power_demand(vehicle, timestep, date_from,
                              date_to, activity=None, power_demand=None, hydrogen=None,
                              detail=None, nb_interval=None, init=False, run=False, post=False):
